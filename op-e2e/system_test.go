...
import (
	...
	"github.com/VMETA3/vmeta3-chain/op-bindings/bindings"
	"github.com/VMETA3/vmeta3-chain/op-node/l2"
	"github.com/VMETA3/vmeta3-chain/op-node/node"
	rollupNode "github.com/VMETA3/vmeta3-chain/op-node/node"
	"github.com/VMETA3/vmeta3-chain/op-node/predeploy"
	"github.com/VMETA3/vmeta3-chain/op-node/rollup"
	"github.com/VMETA3/vmeta3-chain/op-node/rollup/derive"
	"github.com/VMETA3/vmeta3-chain/op-node/testlog"
	"github.com/VMETA3/vmeta3-chain/op-node/withdrawals"
	"github.com/VMETA3/vmeta3-chain/op-proposer/rollupclient"
...
func TestSystemE2E(t *testing.T) {
	...
	depositContract, err := bindings.NewVmeta3Portal(sys.DepositContractAddr, l1Client)
	require.Nil(t, err)
	l1Node := sys.nodes["l1"]
...
func TestWithdrawals(t *testing.T) {
	...
	portal, err := bindings.NewVmeta3Portal(sys.DepositContractAddr, l1Client)
	require.Nil(t, err)
