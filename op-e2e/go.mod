module github.com/VMETA3/vmeta3-chain/op-e2e

go 1.18

require (
	github.com/VMETA3/vmeta3-chain/op-batcher v0.0.0
	github.com/VMETA3/vmeta3-chain/op-bindings v0.0.0
	github.com/VMETA3/vmeta3-chain/op-node v0.0.0
	github.com/VMETA3/vmeta3-chain/op-proposer v0.0.0
...
replace (
	github.com/VMETA3/vmeta3-chain/op-batcher v0.0.0 => ../op-batcher
	github.com/VMETA3/vmeta3-chain/op-bindings v0.0.0 => ../op-bindings
	github.com/VMETA3/vmeta3-chain/op-node v0.0.0 => ../op-node
	github.com/VMETA3/vmeta3-chain/op-proposer v0.0.0 => ../op-proposer
)