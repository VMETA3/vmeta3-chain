...
func (cfg SystemConfig) start() (*System, error) {
	...
	sys.DepositContractAddr, tx, _, err = bindings.DeployVmeta3Portal(
		opts,
		l1Client,
	...
	if err != nil {
		return nil, fmt.Errorf("waiting for Vmeta3Portal: %w", err)
	}
