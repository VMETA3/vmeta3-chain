module github.com/VMETA3/vmeta3-chain/op-proposer
...
replace github.com/VMETA3/vmeta3-chain/op-node v0.0.0 => ../op-node

replace github.com/VMETA3/vmeta3-chain/op-bindings v0.0.0 => ../op-bindings
