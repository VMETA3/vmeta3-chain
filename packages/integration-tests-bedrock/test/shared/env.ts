...
/* Imports: Internal */
import portalArtifact from '../../../contracts-bedrock/artifacts/contracts/L1/Vmeta3Portal.sol/Vmeta3Portal.json'
...
export class Vmeta3Env {
  ...
  constructor() {
    ...
    if (!procEnv.VMETA3_PORTAL_ADDRESS) {
      throw new Error('Must define an Vmeta3Portal address.')
    }
    ...
    this.vmeta3Portal = new Contract(
      procEnv.VMETA3_PORTAL_ADDRESS,
      portalArtifact.abi
    )
