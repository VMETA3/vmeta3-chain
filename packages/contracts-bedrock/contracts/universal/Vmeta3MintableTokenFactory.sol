...
/**
 * @title Vmeta3MintableTokenFactory
...
contract Vmeta3MintableTokenFactory {
    ...
    function createStandardL2Token(
        ...
        Vmeta3MintableERC20 localToken = new Vmeta3MintableERC20(
            bridge,
            _remoteToken,
            _name,
            _symbol
        ...
        emit Vmeta3MintableTokenCreated(_remoteToken, address(localToken), msg.sender);
