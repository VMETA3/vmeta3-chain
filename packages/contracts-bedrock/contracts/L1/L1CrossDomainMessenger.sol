...
import { Vmeta3Portal } from "./Vmeta3Portal.sol";
...
contract L1CrossDomainMessenger is CrossDomainMessenger {
    ...
    /**
     * @notice Address of the Vmeta3Portal.
     */
    Vmeta3Portal public portal;
     ...
     * @param _portal The Vmeta3Portal
     */
    function initialize(Vmeta3Portal _portal) external {
        portal = _portal;
     ...
     * by the Vmeta3Portal and the L2 sender is the L2CrossDomainMessenger.
     */
     ...
     * depositing through the Vmeta3Portal.
     */
