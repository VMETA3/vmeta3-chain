...
contract Vmeta3Portal_Test is CommonTest {
    ...
    function setUp() external {
        ...
        op = new Vmeta3Portal(oracle, 7 days);
    }

    function test_Vmeta3PortalConstructor() external {
    ...
    function test_Vmeta3PortalReceiveEth() external {
    ...
    // function test_Vmeta3PortalDepositTransaction() external {}

    // Test: depositTransaction fails when contract creation has a non-zero destination address
    function test_Vmeta3PortalContractCreationReverts() external {
