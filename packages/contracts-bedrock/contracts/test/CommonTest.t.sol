...
import { Vmeta3MintableTokenFactory } from "../universal/Vmeta3MintableTokenFactory.sol";
import { Vmeta3MintableERC20 } from "../universal/Vmeta3MintableERC20.sol";
import { Vmeta3Portal } from "../L1/Vmeta3Portal.sol";
import { L2ToL1MessagePasser } from "../L2/L2ToL1MessagePasser.sol";
...
contract Messenger_Initializer is L2OutputOracle_Initializer {
    ...
    function setUp() public virtual override {
        ...
        // Deploy the Vmeta3Portal
        op = new Vmeta3Portal(oracle, 100);
        vm.label(address(op), "Vmeta3Portal");
...
contract Bridge_Initializer is Messenger_Initializer {
    ...
    Vmeta3MintableTokenFactory L2TokenFactory;
    Vmeta3MintableTokenFactory L1TokenFactory;
    ERC20 L1Token;
    Vmeta3MintableERC20 L2Token;
    ERC20 NativeL2Token;
    Vmeta3MintableERC20 RemoteL1Token;
    ...
    function setUp() public virtual override {
        ...
        Vmeta3MintableTokenFactory factory = new Vmeta3MintableTokenFactory();
        vm.etch(Lib_PredeployAddresses.L2_STANDARD_TOKEN_FACTORY, address(factory).code);
        L2TokenFactory = Vmeta3MintableTokenFactory(Lib_PredeployAddresses.L2_STANDARD_TOKEN_FACTORY);
        ...
        L2Token = Vmeta3MintableERC20(L2TokenFactory.createStandardL2Token(
            address(L1Token),
        ...
        L1TokenFactory = new Vmeta3MintableTokenFactory();
        L1TokenFactory.initialize(address(L1Bridge));

        RemoteL1Token = Vmeta3MintableERC20(L1TokenFactory.createStandardL2Token(
