...
Refers the Ethereum blockchain, used in contrast to [layer 2][L2], which refers to Vmeta3.

## Layer 2 (L2)

[L2]: glossary.md#layer-2-L2

Refers to the Vmeta3 blockchain (specified in this repository), used in contrast to [layer 1][L1], which
...
Vmeta3 has the following predeploys:
